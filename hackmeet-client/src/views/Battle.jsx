...
import {
  fetchSoal,
  generateQuestion,
} from "../store/actions/question/actionCreator";
  ...
  return (
    ...
    >
      ...
      <div className="container gap-3 py-5 d-flex h-100">
            ...
            >
              {generateCode ? (
                ...
                <div className="position-relative d-flex align-items-center justify-content-center">
                  ...
                  <i
                    className="bi bi-cloud-fill text-white"
                    style={{
                      fontSize: "300px",
                      textShadow: "3px 4px 10px rgba(0, 0, 0, 0.57)",
                    }}
                  ></i>
                </div>
              )}
              <div
                className="d-flex position-absolute gap-1"
                style={{ width: "230px", bottom: 10, right: 5 }}
              >
                <button
                  className="btn w-50 shadow-main text-dark button-hover fw-bold"
                  style={{ backgroundColor: "var(--primary-color)" }}
                  onClick={() => mediaRef.current.handleFindMatch()}
                >
                  Find Match
                </button>
                <button
                  ...
                  onClick={() => mediaRef.current.handleLeaveMatch()}
                >
                  Leave
                </button>
              </div>
        ...
        <div
          className="w-25 shadow-main rounded-4 my-5 d-flex align-items-center justify-content-center p-2 position-relative"
          style={{
            border: "3px solid white",
        ...
        >
          <Chat
            ...
            message={message}
            chats={chats}
            sendMessage={(event) => mediaRef.current.sendMessage(event)}
          />
        </div>
      </div>
    </div>
