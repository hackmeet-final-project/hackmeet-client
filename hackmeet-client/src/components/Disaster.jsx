...
const Disaster = ({setShake}) => {
    ...
    return (
        <div className="d-flex align-items-center justify-content-center position-absolute" style={{bottom: 0, right: "50%", transform: "translate(50%, 50%)", height: "12vh", width: "12vh", zIndex: 9999}}>
